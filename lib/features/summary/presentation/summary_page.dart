...
class _MonthSelector extends ConsumerWidget {
  ...
  Future<void> _openPicker(BuildContext context, WidgetRef ref) async {
    ...
    if (selected != null) {
      ref.read(selectedSummaryPeriodProvider.notifier).state = selected;
    }
  }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    void changeMonth(int delta) {
      ref.read(selectedSummaryPeriodProvider.notifier).state = DateTime(period.year, period.month + delta);
    }
...
/// Grid month/year picker — tapping the month label opens this instead of
/// only offering the prev/next chevrons, so jumping several months or
/// years doesn't take a dozen taps.
